      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="views/icons.php">
                <i class="ni ni-planet text-orange"></i>
                <span class="nav-link-text">Icons</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="views/map.php">
            ...
            <li class="nav-item">
              <a class="nav-link" href="views/upgrade.php">
          ...
          <ul class="navbar-nav mb-md-3">
            ...
            <li class="nav-item">
              <a class="nav-link active active-pro" href="views/upgrade.php">
                <i class="ni ni-send text-dark"></i>
