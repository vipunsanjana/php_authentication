Feature: Draft Posts
  ...
  Scenario: Preview a draft
    ...
    And I should see "Not baked yet." in "_site/recipe.php"

  Scenario: Don't preview a draft
    Given I have a configuration file with "permalink" set to "none"
    And I have an "index.php" page that contains "Totally index"
    And I have a _drafts directory
    And I have the following draft:
      | title  | date       | layout  | content        |
      | Recipe | 2009-03-27 | default | Not baked yet. |
    ...
    Then the _site directory should exist
    And the "_site/recipe.php" file should not exist
  ...
  Scenario: Use page.path variable
    ...
    When I run jekyll build --drafts
    Then the _site directory should exist
    And I should see "Post path: _drafts/recipe.markdown" in "_site/recipe.php"
