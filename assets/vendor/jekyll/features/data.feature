Feature: Data
  ...
  Scenario: autoload *.yaml files in _data directory
    ...
    And I have a "_data/products.yaml" file with content:
      ...
      - name: salt
        price: 2.5
      """
    And I have an "index.php" page that contains "{% for product in site.data.products %}{{product.name}}{% endfor %}"
    When I run jekyll build
    Then the "_site/index.php" file should exist
    And I should see "sugar" in "_site/index.php"
    And I should see "salt" in "_site/index.php"
  ...
  Scenario: autoload *.yml files in _data directory
    ...
    And I have a "_data/members.yml" file with content:
      ...
      - name: Leon
        age: 34
      """
    And I have an "index.php" page that contains "{% for member in site.data.members %}{{member.name}}{% endfor %}"
    When I run jekyll build
    Then the "_site/index.php" file should exist
    And I should see "Jack" in "_site/index.php"
    And I should see "Leon" in "_site/index.php"
  ...
  Scenario: autoload *.yml files in _data directory with space in file name
    ...
    And I have a "_data/team members.yml" file with content:
      ...
      - name: Leon
        age: 34
      """
    And I have an "index.php" page that contains "{% for member in site.data.team_members %}{{member.name}}{% endfor %}"
    When I run jekyll build
    Then the "_site/index.php" file should exist
    And I should see "Jack" in "_site/index.php"
    And I should see "Leon" in "_site/index.php"
  ...
  Scenario: autoload *.yaml files in subdirectories in _data directory
    ...
    And I have a "_data/categories/dairy.yaml" file with content:
      ...
      name: Dairy Products
      """
    And I have an "index.php" page that contains "{{ site.data.categories.dairy.name }}"
    When I run jekyll build
    Then the "_site/index.php" file should exist
    And I should see "Dairy Products" in "_site/index.php"
    ...
    Given I have a "_config.yml" file with content:
      ...
      data:
        ...
        - name: Leon
          age: 34
      """
    And I have an "index.php" page that contains "{% for member in site.data %}{{member.name}}{% endfor %}"
    When I run jekyll build
    Then the "_site/index.php" file should exist
    And I should see "Jack" in "_site/index.php"
    And I should see "Leon" in "_site/index.php"
